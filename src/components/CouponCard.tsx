    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200/50 overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-blue-200/50 group">
      <div className="p-4 sm:p-6">
        ...
        <div className="flex justify-between items-start mb-3 sm:mb-4">
          <h3 className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent group-hover:from-blue-600 group-hover:to-blue-800 transition-all duration-300">
            {coupon.name}
          </h3>
        ...
        <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-100">
          ...
          <button
            ...
            className="px-4 sm:px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full font-medium
                     transform transition-all duration-300 active:scale-95 hover:translate-y-[-2px] hover:shadow-lg
                     touch-manipulation"
          >
